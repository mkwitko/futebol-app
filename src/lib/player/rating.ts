...
export const POSITION_WEIGHTS: Record<FieldPosition, Record<AttributeCategory, number>> = {
  ...
  futsal_ala_esq: { ritmo: 9, finalizacao: 7, passe: 7, drible: 9, defesa: 4, fisico: 6, goleiro: 0 },
  futsal_ala_dir: { ritmo: 9, finalizacao: 7, passe: 7, drible: 9, defesa: 4, fisico: 6, goleiro: 0 },
  ...
  society_zagueiro: { ritmo: 6, finalizacao: 2, passe: 5, drible: 4, defesa: 10, fisico: 8, goleiro: 0 },
  society_lateral_esq: { ritmo: 8, finalizacao: 3, passe: 6, drible: 6, defesa: 8, fisico: 7, goleiro: 0 },
  society_lateral_dir: { ritmo: 8, finalizacao: 3, passe: 6, drible: 6, defesa: 8, fisico: 7, goleiro: 0 },
  ...
  society_ala_esq: { ritmo: 9, finalizacao: 7, passe: 7, drible: 9, defesa: 4, fisico: 6, goleiro: 0 },
  society_ala_dir: { ritmo: 9, finalizacao: 7, passe: 7, drible: 9, defesa: 4, fisico: 6, goleiro: 0 },
  ...
  campo_zagueiro: { ritmo: 6, finalizacao: 2, passe: 5, drible: 4, defesa: 10, fisico: 8, goleiro: 0 },
  campo_lateral_esq: { ritmo: 8, finalizacao: 3, passe: 6, drible: 6, defesa: 8, fisico: 7, goleiro: 0 },
  campo_lateral_dir: { ritmo: 8, finalizacao: 3, passe: 6, drible: 6, defesa: 8, fisico: 7, goleiro: 0 },
  campo_volante: { ritmo: 6, finalizacao: 4, passe: 7, drible: 6, defesa: 9, fisico: 8, goleiro: 0 },
